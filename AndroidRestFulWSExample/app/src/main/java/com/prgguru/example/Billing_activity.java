...
/**
 * Created by PinkalJay on 5/21/15.
 */
/*public class Billing_activity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt1=(TextView)findViewById(R.id.txt_billing);

        Spinner dropdown = (Spinner)findViewById(R.id.spinner1);
        String[] items = new String[]{"Jan-Feb", "Feb-March","March-April","April-May","June-July","July-Aug"};
...
public class Billing_activity extends Activity implements
        AdapterView.OnItemSelectedListener {
        TextView selection;
        String[] items = { "Jan-Feb", "Feb-March","March-April","April-May","June-July","July-Aug"};
    //for ws
...
selection.setText("you have selected..call webservice...");

        }

public void onNothingSelected(AdapterView<?> parent) {
        selection.setText("you have not selected this.....");
        }
