...
public class LoginActivity extends Activity {
	...
	public void invokeWS(RequestParams params){
        ...
        //http://localhost:8055/login/doLogin?phoneNo=123&password=axc
         client.get("http://a06cbb35.ngrok.io/login/doLogin",params ,new AsyncHttpResponseHandler() {
   ...
   public void navigatetoForget_passwordActivity1(View view)
   {
       Intent password_resetlayoutIntent=new Intent(getApplicationContext(),User_changepasswordActivity.class);
