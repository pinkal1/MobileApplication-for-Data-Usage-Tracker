 ...
 */
public class Family_rep extends Activity {
    ListView mListView;
    TextView ver;
    TextView name;
    TextView api;
    ...
    EditText pwdET;
    java.util.List<User> familylist = new ArrayList<User>();
    private FamilyListAdapter familyListAdpater;
    //JSON Node Names
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.familyrep_main);
        oslist = new ArrayList<HashMap<String, String>>();
        //i Btngetdata = (Button)findViewById(R.id.getdata);

        //printing family information
        TextView family_quota = (TextView)findViewById(R.id.totalFamilyQuota);
        family_quota.setText("20"); //total Family Quota

        TextView family_usage = (TextView)findViewById(R.id.totalFamilyUsage);
        family_usage.setText("10");

        mListView = (ListView) findViewById(R.id.familyListView);
        familyListAdpater = new FamilyListAdapter(familylist, getApplicationContext());
        mListView.setAdapter(familyListAdpater);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(view.getContext(),Test_graph.class);
        ...
        client.get("http://a06cbb35.ngrok.io/list/familyUsers", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(String response) {
                try {
                    ...
                    familyListAdpater.updateFamilyList(familylist);
                    errorMsg.setText(strBuilder.toString());
                    if (obj.getBoolean("status")) {
                        Log.i("User list size :", "" + familylist.size());
